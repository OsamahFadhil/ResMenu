    ...
    <div class="fixed top-4 right-4 z-[9999] space-y-3 pointer-events-none">
      ...
      >
        <div
          ...
          class="pointer-events-auto min-w-[320px] max-w-md rounded-lg shadow-lg p-4 flex items-start gap-3"
        >
          <!-- Icon -->
          ...
          <button
            ...
            class="flex-shrink-0 inline-flex rounded-md p-1.5 hover:bg-black/10 transition-colors"
          >
...
const getIcon = (type: string) => {
  const icons = {
    success: () => h('svg', { class: 'h-6 w-6 text-green-600', fill: 'currentColor', viewBox: '0 0 20 20' }, [
    ...
    error: () => h('svg', { class: 'h-6 w-6 text-red-600', fill: 'currentColor', viewBox: '0 0 20 20' }, [
    ...
    warning: () => h('svg', { class: 'h-6 w-6 text-yellow-600', fill: 'currentColor', viewBox: '0 0 20 20' }, [
    ...
    info: () => h('svg', { class: 'h-6 w-6 text-blue-600', fill: 'currentColor', viewBox: '0 0 20 20' }, [
